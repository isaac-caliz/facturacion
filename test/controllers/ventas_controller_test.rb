...
class VentasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create venta" do
    assert_difference("Venta.count") do
      post ventas_url, params: { venta: { cliente_id: @venta.cliente_id, fecha: @venta.fecha, total: @venta.total, vendedor_id: @venta.vendedor_id } }
    end
  ...
  test "should update venta" do
    patch venta_url(@venta), params: { venta: { cliente_id: @venta.cliente_id, fecha: @venta.fecha, total: @venta.total, vendedor_id: @venta.vendedor_id } }
